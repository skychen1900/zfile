...
import im.zhaojun.zfile.repository.dynamoDb.SystemConfigRepository;
import im.zhaojun.zfile.repository.dynamoDb.SystemConfigRepositoryPlugin;
...
public class SystemConfigService {
	...
	@Resource
	private SystemConfigRepositoryPlugin systemConfigRepositoryPlugin;
	...
	public SystemConfigDTO getSystemConfig() {
		...
		for (SystemConfig systemConfig : systemConfigList) {
			String key = systemConfig.getKeyName();
	...
	public void updateSystemConfig(SystemConfigDTO systemConfigDTO) {
		...
		for (Field field : fields) {
			...
			SystemConfig systemConfig = systemConfigRepositoryPlugin.findByKey(key);
	...
	public void updateUsernameAndPwd(String username, String password) {
		SystemConfig usernameConfig = systemConfigRepositoryPlugin.findByKey("keyName", SystemConfigConstant.USERNAME);
		...
		SystemConfig systemConfig = systemConfigRepositoryPlugin.findByKey("keyName", SystemConfigConstant.PASSWORD);
