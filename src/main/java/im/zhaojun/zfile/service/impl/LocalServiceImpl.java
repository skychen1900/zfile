...
public class LocalServiceImpl extends AbstractBaseFileService implements BaseFileService {
	...
	public void init(Integer driveId) {
		...
		filePath = stringStorageConfigMap.get(StorageConfigConstant.FILE_PATH_KEY)
				.getValue();
	...
	public String getDownloadUrl(String path) {
		...
		return StringUtils.removeDuplicateSeparator(
				usernameConfig.getValue() + "/file/" + driveId + ZFileConstant.PATH_SEPARATOR + path);
	}
